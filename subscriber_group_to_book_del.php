         ...
         <div class="container wrapMB">
						      ...
						      { 
								 ...
								 if(mysqli_num_rows($querybook_ds)>=0)
								 {
									 $totalbookval=mysqli_num_rows($querybook_ds);
									  ?>
										<li><a href="subscriber_group_to_book_del.php?groupid=<?php echo $Gid; ?>" target='_self'><?php echo $totalbookval; ?> eBook(s)</a></li>
									 <?php 
								 ...
								 if(mysqli_num_rows($querynotes_ds)>=0)
								 {
									  ...
									  ?>
									  <li><a href="subscriber_group_to_book_del.php?groupid=<?php echo $Gid; ?>" target='_self'><?php echo $totalnotesval; ?> eNote(s)</a></li>
									 <?php 
		   ...
		   <div class="col-xs-12 padd0 ndEco">
					<div class="ndLeftPart" style='width:78%;'>
						<div class="input-group stylish-input-group" style='width:22.5%;'>
						...
						<form class="goBtnForm1" style='margin-right:0px;'>
							<button type="button" class="btn npBtn1 btn-default">Go</button>
						</form>
						<div>
						<a href="subscriber_group_to_book.php?groupid=<?php echo $_GET['groupid']; ?>" target='_self' class='btn npBtn1 btn-default'>ADD BOOK(S)</a>
				...
				<div class="col-xs-12 padd0">
					...
					<?php				
						  ...
						  if(isset($_COOKIE['useremailid']))
						  {
							...
							$Gid = mysqli_real_escape_string($db,$_GET['groupid']);
						    $queryds = mysqli_query($db,"call sp_get_common_data('','".$UserId."','','','','','','A','".$Gid.  "','','','','','','','','','GET_ASSIGNED_GROUP_TO_BOOK')") or die('Query Not execute'.mysqli_error($db));
						    $db->close();
							  ...
							  while($row = mysqli_fetch_array($queryds))
							  {
									...
									echo "<div class='col-xs-12 padd5 npOuterBox'>
										...
										<div class='col-xs-8 paddL10R0 npTitleDiv1'>
											...
											<div class='npIconPC'>
												<a href='delete_group_to_book.php?groupid=$Gid&bookid=$bookid' target='_self'><i class='fa fa-trash-o' aria-hidden='true'></i></a>
											</div>
										</div>
