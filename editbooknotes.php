					...
					<div class="row row03">
					  <?php				
						  ...
						  if($_SESSION['userid']!="")
						  {
						    ...
						    $query = "SELECT * FROM edition where crtd_by='".$UserId."' order by id asc limit 20";
							...
							if(mysqli_num_rows($queryds)>0)
							{
							  while($row = mysqli_fetch_array($queryds))
							  {
									...
									echo "<div class='col-xs-12 col-sm-6 col-md-4 padd03 mtop5' style='height:200px;'>
											  <div class='col-xs-12 padd5 npOuterBox'>
											<div class='col-xs-4 padd0'>
												<img src='$thumbimgpath' alt='Book Cover' class='img-responsive'>
											</div>
											<div class='col-xs-8 paddL10R0 npTitleDiv1'>
												<div class='npBooktitle1'>$booktitle</div>
												<p>by $bookauthor</p>
												<p>Price: $price</p>
