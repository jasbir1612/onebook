	   ...
	   <!-- Code start for get books/notes details -->
		...
		if(isset($_COOKIE['useremailid']))
		{
			if (isset($_POST['submit']))
			{
				...
				if ($msgerror=="false") 
				{
					$resultds = mysqli_query($db,"call sp_insert_booknotes('".$bookid."','".$book_subject."','".$book_course."','".$book_title."','".$book_desc."','".$book_topic."','".$book_publication."','".$book_author."','".$book_edition."','".$book_pages."','".$book_validfor."','".$availability_val."','".$book_printisbn."','".$book_etextisbn."','".$book_thumb."','".$book_large."','".$book_file."','".$book_status."','".$book_active."','".$book_access."','".$book_process."','".$userid."','".$userid."','".$meta_keyword."','".$meta_desc."','".$book_price."','".$book_type."','".$book_partval."','UPDATE_BOOKNOTES_PAGES',@resultmsg,@errormsg)") or die('Query Not execute'.mysqli_error($db));
					$db->close();
