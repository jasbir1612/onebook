					...
					<form class="navbar-form searchBox1" role="search" method="post" id="form1" name="form1" enctype="multipart/form-data" action= "<?php $_PHP_SELF ?>">
						<div class="input-group">
							...
							<div class="input-group-btn">
								<button class="btn btn-default searchBoxBtn" type="submit" name="submit" id="submit" form="form1"  OnClick="return searchvalidation();"><i class="fa fa-search"></i></button>
				 ...
				 $i=1;
				  while($rowcat = mysqli_fetch_array($run))
				  {
					 ...
					 $db->close();
						...
						/*echo "<div id='bsCarousel1' class='carousel slide multi-item-carousel' data-ride='carousel'>
						  <div class='carousel-inner' role='listbox'>
							<div class='item active'>
							  <div class='col-xs-3 carouselItem'>
								<img src='img_chania.jpg' alt='1Chania'>
							  </div>
							</div>

							<div class='item'>
							  <div class='col-xs-3 carouselItem'>
								<img src='img_chania2.jpg' alt='2Chania'>
							  </div>
							</div>

							<div class='item'>
							  <div class='col-xs-3 carouselItem'>
								<img src='img_flower.jpg' alt='3Flower'>
							  </div>
							</div>

							<div class='item'>
							  <div class='col-xs-3 carouselItem'>
								<img src='img_flower2.jpg' alt='4Flower'>
							  </div>
							</div>
							
							<div class='item'>
							  <div class='col-xs-3 carouselItem'>
								<img src='img_flower2.jpg' alt='5Flower'>
							  </div>
							</div>
							
							<div class='item'>
							  <div class='col-xs-3 carouselItem'>
								<img src='img_flower2.jpg' alt='6Flower'>
							  </div>
							</div>
						  </div>
						</div>";*/
