				...
				<div class="col-xs-12">
					  ...
					  <ul class="list-inline bCoverUL xs_widBCoverUL">
						...
						<?php
						 ...
						 include "cs/config.php";
						 $runbook = $db->query("call sp_get_search('','".$Sid."','','','".$searchtxt."','SEARCHBOOKNOTES')");
						 $db->close();
						 $i=1;
						 ...
						 while($rowbook= mysqli_fetch_array($runbook))
						 {
							...
							<div class='bcvrLink'>
									<div class='posRel'>
										<a href='$book_url' target='_self'><img src='$thumbimgpath' alt='Book Cover' class='img-responsive' style='height:190px;' /></a>
						...
						$runbook->close();
						 ...
						 else
						 {
							...
							window.location.href='".$WebSite_URL."bookshelf.html';
							</SCRIPT>");
						 	// echo "<h3>Dayum! It seems like we don’t have what you are looking for. Try looking for it in the <a href='bookshelf.html'>Bookstore</a> by using filters.</h3>";
						 }
					   ?>
