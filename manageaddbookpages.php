...
<html lang="en">
	 ...
	 <!-- functions end for enable/disable the subscription part  -->
		...
		if(isset($_COOKIE['useremailid']))
		{
			if (isset($_POST['submit']))
			{
				...
				//$book_topic= str_replace("'", "''", $book_topic);
				...
				//$book_publication= str_replace("'", "''", $book_publication);
				...
				//$availability_val= str_replace("'", "''", $availability_val);
				$book_edition = mysqli_real_escape_string($db,$_POST['mbForm4edition']);
				//$book_edition= str_replace("'", "''", $book_edition);
				...
				//$book_validfor= str_replace("'", "''", $book_validfor);
				...
				//$book_type= str_replace("'", "''", $book_type);
				...
				$book_partval="1";
				 ...
				 if ($msgerror=="false") 
				{
					echo $resultds = mysqli_query($db,"call sp_insert_booknotes('".$bookid."','".$book_subject."','".$book_course."','".$book_title."','".$book_desc."','".$book_topic."','".$book_publication."','".$book_author."','".$book_edition."','".$book_pages."','".$book_validfor."','".$availability_val."','".$book_printisbn."','".$book_etextisbn."','".$book_thumb."','".$book_large."','".$book_file."','".$book_status."','".$book_active."','".$book_access."','".$book_process."','".$userid."','".$userid."','".$meta_keyword."','".$meta_desc."','".$book_price."','".$book_type."','".$book_partval."','INSERT_BOOKNOTES_PAGES',@resultmsg,@errormsg)") or die('Query Not execute'.mysqli_error($db));
					$db->close();
		...
		<div class="mainWrap">
			...
			<div class="container wrapMB">
				...
				<form method="post" id="form1" name="form1" enctype="multipart/form-data" action="<?php $_PHP_SELF ?>" class="form-horizontal horizontalForm">
					<div class="col-xs-3 paddL0" style='display:none;'>
  ...
  <?php if(isset($_POST['mbOptradio1'])){ if($_POST['mbOptradio1'] == 'NOTES') {echo "checked";}} ?> <?php if($hdnbooktype=="NOTES"){echo 'checked=checked';} ?> disabled='disabled'>&nbsp;&nbsp;Notes
							...
							<div class="form-group">
								<label class="control-label col-sm-2 padd0" for="mbForm1">Chapter Name</label>
								<div class="col-sm-10 paddR0">
									<!--<input type="text" class="form-control" id="mbForm1title" name="mbForm1title" value="<?php echo $book_title_get; ?>">-->
									<input type="text" class="form-control" id="mbForm1title" name="mbForm1title" value="">
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label class="control-label col-sm-2 padd0" for="mbForm6" style='display:none;'>Attempt valid for</label>
								...
								<div class="col-sm-4 paddR0" style='display:none;'>
									...
									<input type="text" class="form-control" id="mbForm7pages" name="mbForm7pages" value="" onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
								</div>
							</div>
							<div class="form-group" style='display:none;'>
							...
							<div class="form-group">
								<label class="control-label col-sm-2 padd0" for="mbForm10">Summary</label>
								<div class="col-sm-10 paddR0">
					...
					<div class="col-xs-12 padd0" style='display:none;'>
						<div class="radioInline">
							...
							<label class="radio-inline">
							<input type="radio" name="mbOptradio2" value="BOTH" form="form1" onclick="enable()" <?php if($availability=="BOTH"){echo 'checked=checked';} ?>>Both of these
							</label>
						</div>
					</div>
